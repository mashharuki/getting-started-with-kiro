...
MCPを活用することで、開発プロセスに自動テストを seamless に統合し、より高品質なソフトウェア開発が可能になります。

次の章では、より本格的なアプリケーション開発に挑戦し、Kiroの高度な機能を活用していきましょう。

---

**前へ**: [1.2 Kiroを使ってテトリスを作ってみよう](tetris-tutorial.md)  
**次へ**: [2章 本格的なアプリを作ろう](../chapter2/ai-consultation.md)  
